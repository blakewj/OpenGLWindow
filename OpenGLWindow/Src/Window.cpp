...
static unsigned int CompileShader(unsigned int type, const std::string& source) {
	...
	//the i and v stand for the inpouts trewquired  int and vecotyr
	int result;
	...
	if (result == GL_FALSE) {
		...
		//alloca is a c++ function that allows you to allocate data to the stack dynamicxally 
...
int main(void)
{
	...
	//index buffer to prevent duplicate verticies
	...
	//the code for the shader used to exisit herec
